...
function stdioConfig$1(param) {
  return /* array */[
          stdioConfig(param.stdin),
          stdioConfig(param.stdout),
          stdioConfig(param.stderr)
        ];
}
...
function execFile(cwd, env, encoding, timeout, maxBuffer, killSignal, uid, gid, windowsHide, windowsVerbatimOptions, shell, cmd, args, cb) {
  var tmp = { };
  if (cwd !== undefined) {
    tmp.cwd = Caml_option.valFromOption(cwd);
  }
  if (env !== undefined) {
    tmp.env = Caml_option.valFromOption(env);
  }
  ...
  if (maxBuffer !== undefined) {
    tmp.maxBuffer = Caml_option.valFromOption(maxBuffer);
  }
  if (killSignal !== undefined) {
    tmp.killSignal = Caml_option.valFromOption(killSignal);
  }
  if (uid !== undefined) {
    tmp.uid = Caml_option.valFromOption(uid);
  }
  if (gid !== undefined) {
    tmp.gid = Caml_option.valFromOption(gid);
  }
  if (windowsHide !== undefined) {
    tmp.windowsHide = Caml_option.valFromOption(windowsHide);
  }
  if (windowsVerbatimOptions !== undefined) {
    tmp.windowsVerbatimOptions = Caml_option.valFromOption(windowsVerbatimOptions);
  }
  if (shell !== undefined) {
    tmp.shell = Caml_option.valFromOption(shell);
  }
  var options = tmp;
...
function spawn(cwd, env, stdio, shell, cmd) {
  ...
  if (stdio$1 !== undefined) {
    tmp.stdio = Caml_option.valFromOption(stdio$1);
  }
  if (shell !== undefined) {
    tmp.shell = Caml_option.valFromOption(shell);
  }
